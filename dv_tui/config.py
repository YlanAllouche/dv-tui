...
class TriggerConfig:
    ...
    on_navigate_cell: Optional[Union[str, Dict[str, Any]]] = None
    on_navigate_row: Optional[Union[str, Dict[str, Any]]] = None
        ...
        if self.triggers:
            result["triggers"] = {
                "table": None if self.triggers.table is None else {
                    ...
                    "on_navigate_row": self.triggers.table.on_navigate_row,
                    "on_navigate_cell": self.triggers.table.on_navigate_cell,
                    "on_startup": self.triggers.table.on_startup,
                    "on_drilldown": self.triggers.table.on_drilldown,
                    "on_backup": self.triggers.table.on_backup,
                ...
                "rows": None if self.triggers.rows is None else {
                    k: {
                        ...
                        "on_navigate_row": v.on_navigate_row,
                        "on_navigate_cell": v.on_navigate_cell,
                        "on_startup": v.on_startup,
                        "on_drilldown": v.on_drilldown,
    ...
    if "triggers" in config and config["triggers"]:
        ...
        if "table" in triggers_data and triggers_data["table"]:
            ...
            result.triggers.table = TriggerConfig(
                ...
                on_navigate_row=td.get("on_navigate_row") or td.get("on_change"),
                on_navigate_cell=td.get("on_navigate_cell"),
                on_startup=td.get("on_startup"),
                on_drilldown=td.get("on_drilldown"),
                on_backup=td.get("on_backup"),
        ...
        if "rows" in triggers_data and triggers_data["rows"]:
            ...
            for key, rd in triggers_data["rows"].items():
                result.triggers.rows[key] = TriggerConfig(
                    ...
                    on_navigate_row=rd.get("on_navigate_row") or rd.get("on_change"),
                    on_navigate_cell=rd.get("on_navigate_cell"),
                    on_startup=rd.get("on_startup"),
                    on_drilldown=rd.get("on_drilldown"),
                    on_backup=rd.get("on_backup"),
        ...
        if "cells" in triggers_data and triggers_data["cells"]:
            ...
            for key, cd in triggers_data["cells"].items():
                result.triggers.cells[key] = TriggerConfig(
                    ...
                    on_navigate_row=cd.get("on_navigate_row") or cd.get("on_change"),
                    on_navigate_cell=cd.get("on_navigate_cell"),
                    on_startup=cd.get("on_startup"),
                    on_drilldown=cd.get("on_drilldown"),
                    on_backup=cd.get("on_backup"),
