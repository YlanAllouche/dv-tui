#!/bin/bash
# Interactive test demonstration for trigger system

set -e

echo "=== Interactive Trigger System Test ==="
echo ""
echo "This script will demonstrate the trigger system with various examples."
echo ""

# Check if we're in an interactive terminal
if [ ! -t 1 ]; then
    echo "Note: Running in non-interactive mode. Some tests may be limited."
fi

# Create a simple interactive test
cat > tests/interactive_test.py << 'PYEOF'
#!/usr/bin/env python3
